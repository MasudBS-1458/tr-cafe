  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="w-full max-w-md p-8 space-y-4 bg-gray-50 rounded-md">
        <h2 className="text-2xl font-bold text-start">Verify OTP</h2>
        ...
        <div className="flex justify-center space-x-2 mb-6">
          {otp.map((digit, index) => (
            <input
              ...
              className="w-12 h-12 text-2xl text-center border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 mt-8 mb-4"
              autoFocus={index === 0}
            />
          ))}
        </div>
