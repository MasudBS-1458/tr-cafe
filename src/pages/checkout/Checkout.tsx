        ...
        <div className="bg-white rounded-md p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full pl-10 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black"
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  ...
                  <label htmlFor="card" className="ml-2 flex items-center">
                    <FaWallet className="mr-2" /> Credit/Debit Card
                  </label>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className={`w-full py-3 px-4 rounded-md text-white font-medium flex justify-center items-center ${items.length === 0 || isSubmitting
